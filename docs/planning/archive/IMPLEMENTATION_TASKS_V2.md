...
Tài liệu này chuyển `docs/planning/archive/PLAN_V2.md` thành backlog thực thi chi tiết cho phase sau MVP.

Khác với `docs/planning/archive/IMPLEMENTATION_TASKS.md`:

- `docs/planning/archive/IMPLEMENTATION_TASKS.md` chốt backlog F01-F16 để hoàn thành MVP
- `docs/planning/archive/IMPLEMENTATION_TASKS_V2.md` chốt backlog **F17-F24** cho V2
...
**Phụ thuộc:** F23  
**Mở khóa:** kế hoạch V3  
**File hoặc module chính:** `app/db/migrations/010_*.sql`, `app/repositories/phases.py`, `app/services/phase_service.py`, `app/api/phases.py`, `app/api/a2a_adapter.py`, `docs/integrations/a2a/A2A_MAPPING.md`
