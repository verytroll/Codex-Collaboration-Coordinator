...
Tài liệu này chuyển `docs/planning/archive/PLAN_V6.md` và `docs/planning/archive/IMPLEMENTATION_ORDER_V6.md` thành backlog thực thi chi tiết cho phase V6.

Khác với `docs/planning/archive/IMPLEMENTATION_TASKS_V5.md`:
- `docs/planning/archive/IMPLEMENTATION_TASKS_V5.md` chốt backlog **F36-F40** cho access boundary, thin operator UI, realtime operator surface, A2A interoperability và small-team deployment
...
**Phụ thuộc:** F40  
**Mở khóa:** F42  
**File hoặc module chính:** `docs/planning/STATUS.md`, `README.md`, `docs/operations/DEPLOYMENT.md`, `docs/operations/LOCAL_SETUP.md`, `docs/operations/RUNBOOK.md`, `scripts/package_release.ps1`, `scripts/smoke.ps1`, thư mục `dist/release/`, release notes hoặc changelog mới
...
- `docs/planning/STATUS.md` và docs chính không còn mô tả mâu thuẫn về phase hiện tại
...
**Phụ thuộc:** F41  
**Mở khóa:** F43  
**File hoặc module chính:** `app/api/`, `app/services/operator_dashboard.py`, `app/services/approval_service.py`, `app/services/job_service.py`, `app/services/session_service.py`, `app/models/api/`, UI operator shell/console, `tests/integration/test_operator_actions.py`, `tests/integration/test_operator_audit_trail.py`, `docs/operator/OPERATOR_UI.md`, `docs/operations/RUNBOOK.md`
...
**Phụ thuộc:** F42  
**Mở khóa:** F44  
**File hoặc module chính:** `app/core/config.py`, `app/api/dependencies.py`, `app/core/middleware.py`, `app/services/authz_service.py` hoặc tương đương, `app/models/`, `app/db/`, `tests/integration/test_operator_rbac.py`, `tests/integration/test_public_authz.py`, `docs/operations/DEPLOYMENT.md`, `docs/operator/OPERATOR_UI.md`, `docs/operations/RUNBOOK.md`
...
**Phụ thuộc:** F43  
**Mở khóa:** F45  
**File hoặc module chính:** `app/main.py`, `app/core/config.py`, `app/db/`, `app/services/`, worker/executor modules, `Dockerfile`, docker compose hoặc script deploy nếu có, `tests/integration/test_durable_runtime.py`, `tests/integration/test_recovery_flow.py`, `docs/operations/DEPLOYMENT.md`, `docs/operations/RUNBOOK.md`, migration SQL mới nếu cần
...
**Phụ thuộc:** F44  
**Mở khóa:** F46  
**File hoặc module chính:** `app/api/`, `app/services/public_event_stream.py`, `app/services/operator_dashboard.py`, `app/models/api/`, UI live modules, `tests/integration/test_operator_streaming.py`, `tests/integration/test_public_streaming.py`, `docs/operator/OPERATOR_UI.md`, `docs/integrations/a2a/A2A_PUBLIC_EVENTS.md`, `docs/operations/OBSERVABILITY.md`
...
**File hoặc module chính:** `app/api/`, `app/services/a2a_public_service.py`, `docs/integrations/a2a/A2A_MAPPING.md`, `docs/integrations/a2a/A2A_PUBLIC_API.md`, `docs/integrations/a2a/A2A_PUBLIC_EVENTS.md`, `docs/integrations/a2a/A2A_QUICKSTART.md`, `docs/operations/DEPLOYMENT.md`, `tests/integration/test_a2a_contract.py`, `tests/integration/test_public_contract.py`, sample client scripts / fixtures / examples
...
### Docs / operations
- mọi feature V6 phải cập nhật ít nhất một trong các tài liệu: `docs/planning/STATUS.md`, `docs/operator/OPERATOR_UI.md`, `docs/operations/DEPLOYMENT.md`, `docs/operations/RUNBOOK.md`, public/A2A docs liên quan
...
- ưu tiên merge PR nhỏ bám `docs/planning/archive/IMPLEMENTATION_ORDER_V6.md`
...
- `docs/planning/archive/PLAN_V6.md` trả lời câu hỏi: V6 nhằm giải quyết vấn đề gì
- `docs/planning/archive/IMPLEMENTATION_ORDER_V6.md` trả lời câu hỏi: nên merge theo thứ tự nào
- `docs/planning/archive/IMPLEMENTATION_TASKS_V6.md` trả lời câu hỏi: cần làm cụ thể những gì để hoàn tất từng F
