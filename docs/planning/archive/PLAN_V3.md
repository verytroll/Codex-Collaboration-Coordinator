...
Khác với `docs/planning/archive/PLAN_V2.md`:

- `docs/planning/archive/PLAN_V2.md` tập trung làm dày nền coordinator để vận hành tốt hơn
- `docs/planning/archive/PLAN_V3.md` tập trung mở **public collaboration surface** và **orchestration depth** trên nền đã có
...
- `docs/planning/archive/IMPLEMENTATION_TASKS_V3.md`
- `docs/planning/archive/IMPLEMENTATION_ORDER_V3.md`
