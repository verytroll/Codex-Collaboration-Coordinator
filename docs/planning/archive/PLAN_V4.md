...
Khác với `docs/planning/archive/PLAN_V3.md`:

- `docs/planning/archive/PLAN_V3.md` tập trung mở public collaboration surface, orchestration depth và runtime/operator surface
...
- `docs/planning/archive/IMPLEMENTATION_TASKS_V4.md`
- `docs/planning/archive/IMPLEMENTATION_ORDER_V4.md`
