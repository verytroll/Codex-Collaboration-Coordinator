...
Tài liệu này chuyển `docs/planning/archive/PLAN_V6.md` thành **thứ tự triển khai thực chiến theo PR nhỏ** cho V6.

Khác với `docs/planning/archive/IMPLEMENTATION_ORDER_V5.md`:
- `docs/planning/archive/IMPLEMENTATION_ORDER_V5.md` chốt **PR38-PR42** cho access boundary, thin operator UI, realtime operator surface, A2A interoperability và small-team deployment
...
Nếu bạn dùng cùng `docs/planning/archive/PLAN_V6.md`:
