...
Tài liệu này chuyển `docs/planning/archive/IMPLEMENTATION_TASKS_V3.md` thành **thứ tự triển khai thực chiến theo PR nhỏ** cho V3.

Khác với `docs/planning/archive/IMPLEMENTATION_ORDER_V2.md`:

- `docs/planning/archive/IMPLEMENTATION_ORDER_V2.md` chốt **PR19-PR26** cho V2 foundation
- `docs/planning/archive/IMPLEMENTATION_ORDER_V3.md` chốt **PR27-PR33** cho V3
...
Nếu bạn dùng cùng `docs/planning/archive/IMPLEMENTATION_TASKS_V3.md`:

- `docs/planning/archive/IMPLEMENTATION_TASKS_V3.md` trả lời câu hỏi: **phải code module nào**
- `docs/planning/archive/IMPLEMENTATION_ORDER_V3.md` trả lời câu hỏi: **nên merge theo thứ tự nào**
