...
Tài liệu này chuyển định hướng `docs/planning/archive/PLAN_V5.md` thành **thứ tự triển khai thực chiến theo PR nhỏ** cho V5.

Khác với `docs/planning/archive/IMPLEMENTATION_ORDER_V4.md`:
- `docs/planning/archive/IMPLEMENTATION_ORDER_V4.md` chốt **PR34-PR37** cho hardening, telemetry, release readiness và deployment readiness
- `docs/planning/archive/IMPLEMENTATION_ORDER_V5.md` chốt **PR38-PR42** cho access boundary, thin operator UI, realtime operator surface, A2A interoperability và small-team deployment profile
...
- Sau mỗi PR nên cập nhật `docs/planning/STATUS.md` ngay thay vì chờ cuối phase.
