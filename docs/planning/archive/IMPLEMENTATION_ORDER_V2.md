...
Tài liệu này chuyển `docs/planning/archive/IMPLEMENTATION_TASKS_V2.md` thành **thứ tự triển khai thực chiến theo PR nhỏ** cho phase sau MVP.

Khác với `docs/planning/archive/IMPLEMENTATION_ORDER.md`:

- `docs/planning/archive/IMPLEMENTATION_ORDER.md` chốt PR01-PR18 để hoàn thành MVP
- `docs/planning/archive/IMPLEMENTATION_ORDER_V2.md` chốt **PR19-PR26** cho V2
...
Nếu bạn dùng cùng `docs/planning/archive/IMPLEMENTATION_TASKS_V2.md`:

- `docs/planning/archive/IMPLEMENTATION_TASKS_V2.md` trả lời câu hỏi: **phải code module nào**
- `docs/planning/archive/IMPLEMENTATION_ORDER_V2.md` trả lời câu hỏi: **nên merge theo thứ tự nào**
