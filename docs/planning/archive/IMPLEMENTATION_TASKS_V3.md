...
Tài liệu này chuyển `docs/planning/archive/PLAN_V3.md` thành backlog thực thi chi tiết cho phase V3.

Khác với `docs/planning/archive/IMPLEMENTATION_TASKS_V2.md`:

- `docs/planning/archive/IMPLEMENTATION_TASKS_V2.md` chốt backlog **F17-F24** cho V2 foundation
- `docs/planning/archive/IMPLEMENTATION_TASKS_V3.md` chốt backlog **F25-F31** cho V3
...
**Phụ thuộc:** F24  
**Mở khóa:** F26  
**File hoặc module chính:** `app/models/api/a2a_public.py`, `app/api/a2a_public.py`, `app/services/a2a_public_service.py`, `app/services/a2a_adapter.py`, `tests/integration/test_a2a_public_api.py`, `docs/integrations/a2a/A2A_PUBLIC_API.md`
