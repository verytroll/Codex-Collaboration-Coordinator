...
Tài liệu này chuyển `docs/planning/archive/IMPLEMENTATION_TASKS_V4.md` thành **thứ tự triển khai thực chiến theo PR nhỏ** cho V4.

Khác với `docs/planning/archive/IMPLEMENTATION_ORDER_V3.md`:

- `docs/planning/archive/IMPLEMENTATION_ORDER_V3.md` chốt **PR27-PR33** cho V3 foundation
- `docs/planning/archive/IMPLEMENTATION_ORDER_V4.md` chốt **PR34-PR37** cho V4 hardening, telemetry, release readiness và deployment readiness
...
Nếu bạn dùng cùng `docs/planning/archive/IMPLEMENTATION_TASKS_V4.md`:

- `docs/planning/archive/IMPLEMENTATION_TASKS_V4.md` trả lời câu hỏi: **phải code module nào**
- `docs/planning/archive/IMPLEMENTATION_ORDER_V4.md` trả lời câu hỏi: **nên merge theo thứ tự nào**
