...
- [x] Chốt thứ tự triển khai V4 (`docs/planning/archive/IMPLEMENTATION_ORDER_V4.md`) - 2026-04-01
- [x] Chuẩn bị backlog V4 (`docs/planning/archive/IMPLEMENTATION_TASKS_V4.md`) - 2026-04-01
- [x] Chốt kế hoạch V4 (`docs/planning/archive/PLAN_V4.md`) - 2026-04-01
