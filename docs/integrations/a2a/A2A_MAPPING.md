...
For the public v1 contract, see `docs/integrations/a2a/A2A_PUBLIC_API.md`.
For the companion public event surface, see `docs/integrations/a2a/A2A_PUBLIC_EVENTS.md`.
For supported-versus-experimental scope, see `docs/integrations/a2a/A2A_COMPATIBILITY_MATRIX.md`.
