...
### Công việc
1. Tạo repo và cấu trúc thư mục theo `ARCHITECTURE.md`
...
**Phụ thuộc:** G01  
**Mở khóa:** G03  
**Kết quả:** có migration, repository và các model DB tối thiểu theo `DB_SCHEMA.md`
...
Từ đây, tài liệu phù hợp để bắt đầu code ngay là `IMPLEMENTATION_TASKS.md`.
