# Kế hoạch phát triển dự án sau MVP: Codex Collaboration Coordinator
...
- `PLAN.md` chốt phạm vi từ F01 đến F16 để bàn giao MVP
- `PLAN_V2.md` chốt hướng phát triển **post-MVP / V2**
