...
Tài liệu này chuyển `IMPLEMENTATION_TASKS.md` thành **thứ tự triển khai thực chiến theo PR nhỏ**.

Khác với các tài liệu khác:

- `PLAN.md` mô tả lộ trình cấp dự án
- `IMPLEMENTATION_TASKS.md` mô tả backlog theo module
- `IMPLEMENTATION_ORDER.md` mô tả **nên code cái gì trước, gộp thành PR nào, mỗi PR cần đạt gì**
...
Nếu bạn dùng cùng `IMPLEMENTATION_TASKS.md`:
- `IMPLEMENTATION_TASKS.md` trả lời câu hỏi: **phải code module nào**
- `IMPLEMENTATION_ORDER.md` trả lời câu hỏi: **nên merge theo thứ tự nào**
