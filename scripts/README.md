...
- `smoke.ps1` validate health, readiness, agent card, seed data, phase presets, finalize activation, and basic A2A projection while waiting for the app to become ready
