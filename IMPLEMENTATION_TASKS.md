...
Tài liệu này chuyển `PLAN.md` thành backlog thực thi chi tiết hơn.

Khác với `PLAN.md`:

- `PLAN.md` nói về **lộ trình và mốc lớn**
- `IMPLEMENTATION_TASKS.md` nói về **việc cần code cụ thể**, theo module, file và thứ tự phụ thuộc
